...
**NOT for:**
- Diagnosing a failure happening right now — use the systematic-debugging skill (`../../superpowers/systematic-debugging/SKILL.md`; observability is what makes that skill fast next time)
