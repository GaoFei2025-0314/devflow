# Shared Phase and Delivery Contract — full text

This is the complete contract. The normative core every route reads is
[phase-contract.md](phase-contract.md); this file carries the full wording behind it and
is read when a section here is cited. The rules are identical — the core states them, this
file elaborates them.
