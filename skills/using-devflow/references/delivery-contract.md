...
- A required failed check blocks its dependent completion or action gate. Keep the failure and any later retry in the record; do not replace history with the final green result.
