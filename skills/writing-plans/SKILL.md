...
**Boundary:** This skill writes fully self-contained plans for a zero-context executor (typically feeding subagent-driven execution). For a lighter task list with acceptance criteria driven from a spec, use `../planning-and-task-breakdown/SKILL.md` instead. Both end the same way: an explicit execution handoff.
